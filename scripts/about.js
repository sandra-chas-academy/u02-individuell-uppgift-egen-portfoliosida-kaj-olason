...
const educationLoader = document.getElementById("educationLoader");

function showLoader() {
  workLoader.classList.add("showLoader");
  educationLoader.classList.add("showLoader");
}

function hideLoader() {
  workLoader.classList.remove("showLoader");
  educationLoader.classList.remove("showLoader");
}
...
function getData() {
  ...
  fetch("data/experienceData.json")
    ...
    .then((data) => {
      ...
      function renderData() {
        hideLoader();
        createWorkHTMLdata(data.workexperience);
        createEducationHTMLdata(data.education);
      }
    })
...
const createEducationHTMLdata = (data) => {
  data.map((item) => {
    const experienceItem = document.createElement("div");
    experienceItem.classList.add("experienceItem");
